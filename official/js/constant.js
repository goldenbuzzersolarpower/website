...
const FAQS = [
    ...
    },
    {
        ...
        answer: "Panels are generally warranted for 25–30 years and can continue to produce around 80–90% of their rated capacity after 20 years."
    },
    {
...

    {
        ...
        answer: "The cost of a solar power system varies depending on factors such as your monthly electricity bill, system size, and the type of appliances used. It is best to contact a GOLDEN BUZZER representative to determine the system that best fits your needs."
    },
    {
        question: "What are your modes of payment?",
        answer: "We aim to make solar energy more accessible to every Filipino by offering various payment schemes and financing options."
    },
    {
        question: "How many solar panels do I need for our house?",
        answer: "The number of solar panels required depends on factors such as the size of the house, electricity consumption, and available roof space. A GOLDEN BUZZER representative can evaluate your energy usage, sun exposure, and local conditions to determine the ideal system for your home."
    },
    {
        question: "How does solar power work?",
        answer: "Solar power works by capturing energy from the sun using solar panels made of photovoltaic cells. These cells convert sunlight into direct current (DC) electricity. An inverter then converts the DC electricity into alternating current (AC) electricity that can be used in homes or businesses. Excess electricity may be stored in batteries or sent to the electrical grid."
    },
    {
        question: "What is a grid-tie system?",
        answer: "A grid-tied solar system, also known as an on-grid system, is connected to the local utility grid. Solar panels generate electricity for the home or business, and any excess energy is sent back to the grid through a net meter, which records both electricity production and consumption."
    },
    {
        question: "What is a hybrid solar system?",
        answer: "A hybrid solar system combines a grid-tied system with battery backup. It stores excess electricity generated by the solar panels in batteries for use when solar production is low or during power outages."
    },
    {
        question: "How long does it take to install a solar power system?",
        answer: "Installation time varies depending on site accessibility and weather conditions. However, a typical residential solar power system can usually be installed within one day."
    },
    {
        question: "Is there a warranty for my system?",
        answer: "Yes. GOLDEN BUZZER provides a workmanship warranty, while the major components are covered by manufacturer warranties. The length of coverage depends on the brand of equipment used."
    },
    {
        question: "Do solar panels work at night?",
        answer: "Solar panels do not generate electricity at night because they require sunlight. However, stored energy in batteries or electricity from the grid can be used during nighttime."
    },
    {
        question: "Do solar panels work during rainy days?",
        answer: "Yes. Solar panels can still generate electricity during rainy or cloudy days, although production will be lower than on sunny days. Solar panels are designed to withstand various weather conditions, including rain."
    },
    {
        question: "What is net metering?",
        answer: "Net metering is a billing arrangement that allows homeowners with solar systems to send excess electricity back to the grid in exchange for credits on their utility bill. These credits help offset the cost of electricity drawn from the grid when solar production is low."
    }
];
